...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://github.com/wts-thomas/expesites-default/',
	__FILE__,
	'expesites-default'
);
...
function custom_dashboard_help() {
   ...
   <div style="text-align:center;">
       <a href="https://expesites.com/support/" title="Contact ExpeSites" target="_blank">
           <img src="'.get_template_directory_uri().'/img/expesites-logo_whiteback.png" alt="ExpeSites" style="max-width:100%;width:80%;height:auto;margin:20px auto;">
       </a>
   </div>
   <p>
      Contact <a href="https://expesites.com/support/" title="Contact ExpeSites" target="_blank">Contact ExpeSites</a> with questions, troubleshooting, edit for requests or alterations, or misc support you have with your custom built website.
   </p>
   <p><strong><a href="https://expesites.com/support/" title="Contact ExpeSites" target="_blank">Contact ExpeSites</a></strong></p>
   ';
}
function exp_custom_dashboard_widgets() {
   global $wp_meta_boxes;
   wp_add_dashboard_widget('custom_help_widget', 'Website Support', 'custom_dashboard_help');
}
add_action('wp_dashboard_setup', 'exp_custom_dashboard_widgets');
...
function expesitestheme_sidebar() {
	register_sidebar(
		array (
			'name' => __( 'Default Sidebar', 'expesites-default' ),
			'id' => 'custom_sidebar_01',
			'description' => __( 'Custom sidebar that can be used with Elementor templates.', 'expesites-default' ),
			'before_widget' => '<div class="widget-content">',
			'after_widget' => "</div>",
		)
	);
}
add_action( 'widgets_init', 'expesitestheme_sidebar' );
