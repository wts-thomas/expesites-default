...
* Function file cleanup and organziation

= 2.0.1 - 01-23-2025 =
* Added back the reCaptha defer function

= 2.0.0 - 01-22-2025 =
* Removed Styles and Functions for Custom Dividers
* Removed reCaptha defer function
* Removed TinyMCE Image Text Wrap styles
* Removed Drop Shadow styles
* Removed Text Leaders
* Updated-Fixed videoContainer styles
* Added additional Menus that could be created
* Added additional named page templates, e.g. About and Contact
* Removed unused WordPress cancel autosave function

= 1.2.0 - 01-21-2025 =
* Added checkbox to hide Comments in Admin
* Removed TinyMCE and Yoast Pro javascript used for editing in favor of no longer needing them
* Added global javascript and styles for Scroll to Hide header elements 
...
* Added updated page templates and removed outdated versions
* Removed TinyMCE function and scripts

= 1.0.5 - 11-19-2024 =
* Additonal adjustments to hiding Elementor edit functions

= 1.0.4 - 11-18-2024 =
* Hides Core updates from non Admin Users

= 1.0.3 - 11-18-2024 =
* Additional checkbox to hide Edit with Elementor links when viewing all pages

= 1.0.2 - 10-24-2024 =
* License and Sync Plugin Added

= 1.0.1 - 10-24-2024 =
* Organziation of Functions and Styles for Initial Launch
...
* Added new Landing Page templates
* Adds checkbox to disable function to hide menu items
...
* Refactored function to hide admin menus
...
* Hides Dashboard Screen Option Meta Boxes to show Support card by default
